...
public class ApproveOrderHandlerTests
{
    ...
    {
        _handler = new AcceptOrderHandler(_repository.Object, _unitOfWork.Object);
    }

    [Fact]
    public async Task Handle_ShouldApproveOrderRequest_AndPersistChanges()
    {
        ...
        var command = new AcceptOrderCommand(orderRequest.Id);
    ...
    {
        var command = new AcceptOrderCommand(new OrderRequestId(Guid.NewGuid()));
